...
// Fallback KSU manager URL used only when the feed does not name a manager URL.
// Points to upstream since the fork does not maintain its own KSU build.
    ...
    LazyColumn(
        ...
        item {
            Column(verticalArrangement = Arrangement.spacedBy(2.dp)) {
                ...
                // LocaleManager.getApplicationLocales() requires API 33+.
                // Hide the language picker entirely on older OS versions.
...
private const val ROOT_MY_DEVICE_URL = "https://github.com/Dimonchik225820/Root-My-Device"
